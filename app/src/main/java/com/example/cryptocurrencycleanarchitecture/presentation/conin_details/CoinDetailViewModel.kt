...
import com.example.cryptocurrencycleanarchitecture.domain.use_case.get_coin.GetCoinUseCase
...
class CoinDetailViewModel @Inject constructor(
    ...
    init {
       savedStateHandle.get<String>(Constants.PARAM_CODE_ID)?.let { coindId->
           getCoins(coindId)
       }
    }
